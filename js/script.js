const doctorsData = [
    ...
    },
    {
        ...
        "speciality": "Internal Medicine",
        "subSpeciality": "Infectious Diseases",
        "type": "Sessional",
    ...
    },
    {
        ...
        "subSpeciality": "N/A",
        "type": "Sessional",
        "qualifications": "MBBS International Medical University (IMU), MALAYSIA, MRCPCH (UK), Paediatric Respiratory (HTA, UMMC, HPP and Royal Children? Hospital Melbourne, Australia)",
        "languages": [
            "English",
            "Mandarin",
            "Malay",
    ...
    },
    {
        ...
        "subSpeciality": "Interventional Cardiology",
        "type": "Resident",
        "qualifications": "MBBS(UM), MRCP(UK), AM(Malaysia), Board Cert - Cardiology(S?ore), FAMS Cardiology (S?ore), Fellowship - TRI & Interventional Cardiology (Taiwan), ACSM CES(USA), FAPSIC (Asia Pacific), FESC (Europe)",
        "languages": [
            "English",
            "Malay",
            "Mandarin",
...
function setupIndexPage() {
    ...
    function renderDoctorCards(doctors) {
        ...
        doctors.forEach(doctor => {
            ...
            // QR Code generation (qrcode.min.js - to be replaced)
